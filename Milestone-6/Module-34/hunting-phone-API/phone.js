...
//   Clear phone conatiner before adding new container
phoneContainer.textContent = '';

// display show all btn if there are more 12 phones
...
const showPhoneDetails = (phone) =>{
    ...
    const showDetailContainer = document.getElementById('show-detial-container');
